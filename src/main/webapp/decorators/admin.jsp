...
<body>
	...
	<nav class="navbar bg-light navbar-light">
		...
		<div class="navbar-nav w-100">
			...
			<a href="${pageContext.servletContext.contextPath}/admin/category" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Category</a> 
			
			<a href="${pageContext.servletContext.contextPath}/admin/order" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Order</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="${pageContext.servletContext.contextPath}/${sessionScope.avatar}" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">Jhon send you a message</h6>
                                        <small>15 minutes ago</small>
                                    </div>
