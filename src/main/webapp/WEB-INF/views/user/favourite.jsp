                ...
                <div class="col-sm-4 product2">
                    <div class="row m0 thumbnail">
                        <div class="row m0 imgHov">
                            <img src="${contextPath }/${f.image}" alt="">
                            <div class="hovArea row m0">
                                <div class="links row m0">
                                    <a href="single-product.html"><i class="fas fa-link"></i></a>
                                    <a class="lightbox" href="${contextPath }/${f.image}" data-lightbox="product1" data-title="Maximus quam posuere"><i class="fas fa-expand"></i></a>
                                </div>
                                <div class="row m0 getlike">
                                    <a href="#" onclick="addBasket('${f.productId}')" class="fleft"><i class="fas fa-shopping-cart"></i> Add to cart</a>
                                    <a href="#" class="fright"><i class="fas fa-shopping-cart-alt"></i></a>
                                    <a href="#" onclick="removeItems('${f.productId}')"	 class="fright"><i class="far fa-trash-alt"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="row m0 productIntro">
                            <h5 class="heading"><a href="${contextPath}/detail/${f.productId}">${f.name }</a> <span><%-- <del><fmt:formatNumber value="${p.price}"/>vnđ</del>  --%><fmt:formatNumber value="${f.salePrice}"/>vnđ</span></h5>
